...
public class OtherFollowingItemView extends FrameLayout {
	...
	public OtherFollowingItemView(Context context) {
		super(context);
		init();
	}
	...
	private void init() {
		...
		ivFace.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (mListener != null) {
					mListener.onFaceClick(OtherFollowingItemView.this, data);
				}
			}
		});
		...
		ivPhoto.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (mListener != null) {
					mListener.onPhotoClick(OtherFollowingItemView.this, data);
				}
			}
		});
