...
String userId;
	...
	public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
		...
		tvAlert.setText("ÆÈ·ÎÀ× ÇÏ½Ã°Ú½À´Ï±î?");
		...
		btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				NetworkManager.getInstance().setUserFollow(getActivity(), userId, new OnResultListener<MyUserResultList>() {

					@Override
					public void onSuccess(MyUserResultList result) {
						if(result.success==1){
							Toast.makeText(getActivity(), "ÆÈ·ÎÀ× µÇ¾ú½À´Ï´Ù.", Toast.LENGTH_SHORT).show();
							dismiss();
						}else{
					...
					public void onFail(int code) {
						Toast.makeText(getActivity(), "follow_onFail", Toast.LENGTH_SHORT).show();
