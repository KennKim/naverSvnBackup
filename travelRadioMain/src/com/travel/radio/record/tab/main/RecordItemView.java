...
public class RecordItemView extends FrameLayout {
	...
	public interface OnPhotoClickListener {
		public void onPhotoClick(RecordItemView view, Records records);
		public void onFaceClick(RecordItemView view, Records records);
	}
	...
	private void init() {
		...
		ivFace.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if(mListener != null){
					mListener.onFaceClick(RecordItemView.this, data);
				}
			}
		});
		...
		ivPhoto.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (mListener != null) {
					mListener.onPhotoClick(RecordItemView.this, data);
				}
			}
		});
	...
	public void setData(Records data) {
		this.data = data;
//		Toast.makeText(getContext(), data.name + " - " + data.recordPlace, Toast.LENGTH_SHORT).show();
...
//		if(data.images==null || data.images.equals("")){
//			 
//		}else{
			
			mLoader.displayImage(data.images.get(0).imgName, ivPhoto);
//		}
