...
public class LocationHeaderView extends FrameLayout {
	...
	private void init() {
		LayoutInflater.from(getContext()).inflate(R.layout.tab_location_header,	this);
...
//						if (isChecked) { // 선택
							if(mListener != null){
								mListener.onCheckBoxClick(LocationHeaderView.this, data);
							}
//						}
					}
				});
...
//				break;
//			case RADIUS4:
//				rbR4.setChecked(true);
//				break;
//			case RADIUS5:
//				rbR5.setChecked(true);
//				break;
//			}
//		}
