...
public class VoiceRecordMachine2 extends ActionBarActivity {
...
//				sendBroadcast(intent);
				...
				String content="";
				String voice=outputFile.getAbsolutePath();
				NetworkManager.getInstance().setVoiceMsgSend(getApplicationContext(), content, voice, receiveId, new OnResultListener<VoiceResultList>() {
					
					@Override
					public void onSuccess(VoiceResultList result) {
						if(result.success==1){
							Toast.makeText(VoiceRecordMachine2.this, result.result.msg, Toast.LENGTH_LONG).show();
							finish();

						}else{
							Toast.makeText(VoiceRecordMachine2.this, result.result.msg, Toast.LENGTH_SHORT).show();
						}						
					}
					
					@Override
					public void onFail(int code) {
						Toast.makeText(VoiceRecordMachine2.this, "voiceSend_onfail", Toast.LENGTH_SHORT).show();
